# 🔱 Recon113 — Product Requirements Document (PRD)
...
Recon113 is a production-ready, modular, CLI-based automated reconnaissance and vulnerability scanning tool designed for penetration testers and security researchers. It accepts a domain, subdomain, URL, or IP address and performs a comprehensive security assessment — from passive/active recon to vulnerability scanning — then generates a stunning hacker-themed HTML report.
...
```mermaid
graph TB
    A["CLI Entry Point<br/>Recon113.py"] --> B["Core Engine<br/>engine.py"]
...
|--------|------|-------------|
| **CLI Interface** | `Recon113.py` | argparse-based entry point, banner display, orchestration |
...
```
usage: Recon113.py [-h] -t TARGET [-o OUTPUT] [--threads THREADS]
...
🔱 Recon113 v1.0.0 — Automated Recon & Vulnerability Scanner by Megh

Required:
  -t, --target TARGET     Target domain, URL, or IP address

Options:
  -o, --output OUTPUT     Output directory (default: ./Recon113_output)
