...
class Logger:
    """Custom logger providing styled console output for Recon113."""
...
[bold dim]  Version 1.0.0 | Author: Megh[/bold dim]
[bold cyan]  ═══════════════════════════════════════════════[/bold cyan]
"""

    @staticmethod
    def banner():
        """Display the Recon113 ASCII banner."""
    ...
    def scan_complete(duration, output_path):
        ...
        console.print(Panel(
            ...
            title="[bold green]Recon113 COMPLETE[/bold green]",
            border_style="green",
            box=box.DOUBLE_EDGE,
            padding=(1, 2)
        ))
