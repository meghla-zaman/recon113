<p align="center">
  <img src="screenshots/banner.png" alt="Recon113 Banner" width="100%"/>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/license-Educational-2563eb?style=for-the-badge" alt="License">
  <img src="https://img.shields.io/badge/version-1.0.0-dc2626?style=for-the-badge" alt="Version">
  <img src="https://img.shields.io/badge/SecLists-Integrated-d97706?style=for-the-badge" alt="SecLists">
</p>
...
### CLI — Terminal Output
<p align="center">
  <img src="screenshots/cli_banner.png" alt="Recon113 CLI Banner" width="80%"/>
</p>

### Vulnerability Scanning in Action
<p align="center">
  <img src="screenshots/cli_scan.png" alt="Recon113 Vulnerability Scanning" width="80%"/>
</p>

### HTML Report — Interactive Dashboard
<p align="center">
  <img src="screenshots/html_report.png" alt="Recon113 HTML Report Dashboard" width="100%"/>
</p>
...
python3 recon113.py -t scanme.nmap.org
```

### Step 3: View Report

```bash
firefox recon113_output/*/report.html
```
...
# Run
python3 recon113.py -t example.com
```
...
# Scan an IP address
python3 recon113.py -t 192.168.1.1

# Scan a full URL
python3 recon113.py -t https://target.com

# Full scan with external tools
python3 recon113.py -t example.com --nikto --nuclei

# Stealth mode (slower, evasive scanning)
python3 recon113.py -t example.com --stealth

# Custom threads and depth
python3 recon113.py -t example.com --threads 20 --depth 5

# Skip specific phases
python3 recon113.py -t example.com --skip-crawl --skip-vuln

# Show help
python3 recon113.py -h
```
...
### 📊 Reporting
- **HTML Report** — Clean professional theme
...
```
usage: recon113.py [-h] -t TARGET [-o OUTPUT] [--threads N] [--timeout N]
...
| `-o, --output` | Output base directory | `recon113_output` |
...
- 📊 **Dashboard** with statistics and severity donut chart
...
```bash
docker build -t recon113 .
docker run --rm -v $(pwd)/output:/app/recon113_output recon113 -t example.com
```
...
<p align="center">
  <b>Built with ❤️ by Megh</b><br>
  <sub>Recon113 — See everything. Miss nothing.</sub>
</p>
