#!/usr/bin/env python3
"""
Recon113 - Automated Reconnaissance & Vulnerability Scanner
Author: Megh
Version: 1.0.0

Main CLI entry point. Run: python recon113.py -t <target>
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python recon113.py -t example.com
  python recon113.py -t https://example.com -o results --threads 20
  python recon113.py -t 192.168.1.1 --nikto --nuclei
  python recon113.py -t example.com --stealth --depth 5
  python recon113.py -t example.com --skip-vuln
        """
    )
    ...
    parser.add_argument(
        "-o", "--output",
        default=None,
        help="Output directory (default: recon113_output)"
    )
